	...
	<body style="background: #ddd;">
		<div class="container">
			...
			<nav style="padding: 0px;" class="navbar navbar-expand-sm bg-dark navbar-light">
				<ul class="navbar-nav">
					...
					<li class="nav-option">
						<a class="ad nav-link" href="<?php echo base_url('cuti/daftar_verifikasi'); ?>">Verifkikasi Cuti</a>
					</li>
				...
				<div class="row">
					<div class="col-md-6 col-sm-12">
							...
							<div class="row">
								<div class="col-md-3">
									Sisa Cuti
									<input type="hidden" value="12" name="kuota" id="kuotas">
								</div>
								<div class="col-md-9" id="sisa_cuti">
							...
							<div class="row">
								...
								<div class="col-md-9">
									<div class="row">
										<div class="col-md-8">
											<input min="1"  name="lama" class="form-control" type="number" placeholder="Masukan Lama Hari" id="lama">
					...
					<div class="col-md-6 col-sm-12 wow">
						...
						<div class="row">
							...
							<div class="col-md-3">
								<button type="button" class="btn modf btn-info" data-toggle="modal" data-target="#myModal">Pilih Pegawai</button>
							</div>
						</div>
						<div class="row">
							<div class="col-md-3">
		...
		<script type="text/javascript">
			...
			$('#exampleModal').on('hidden.bs.modal', function (e) {
        		...
        		$.ajax({
          			url: "<?php echo base_url('/cuti/json_jml_cuti'); ?>",
          			type : 'post',
          			data: "nip="+nip, 
          			success: function(result){
            			...
            			{
            				$("#sisa_cuti").html(12-json.jumlah);
            				$("#kuotas").val(12-json.jumlah);
            				$("#lama").attr("max",12-json.jumlah);
            			}
