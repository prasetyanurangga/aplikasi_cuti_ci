			...
			<div class="row">
				...
				<div class="col-md-4 col-sm-12 py-3 bagian" style="height: 100%;">
					<div class="bagian2">
						...
						<ul class="list-group">
							<a href="<?php echo base_url('/cuti/atasan'); ?>">
								<li class="list-group-item d-flex align-items-center">
									<span style="color: #545353;" class="fas fa-paper-plane"></span>
									<span style="margin-left: 10px;">Pengajuan Cuti Online</span>
								</li>
							</a>
							<a href="<?php echo base_url('cuti/daftar_verifikasi'); ?>">
								<li class="list-group-item d-flex align-items-center">
									<span style="color: #545353;" class="fas fa-check-circle"></span>
									<span style="margin-left: 10px;">Verifikasi Cuti</span>
								</li>
							</a>
